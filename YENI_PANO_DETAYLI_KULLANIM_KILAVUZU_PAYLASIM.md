...
Bu paylasim surumunde guvenlik nedeniyle PIN/sifre degerleri gizlenmistir.

- Rol yapisi: `viewer`, `editor`, `admin`
- PIN degerleri: gizli
- Oturum suresi: kurum politikaniza gore ayarlanir
